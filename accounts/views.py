...
def profile_view_by_id(request, user_id):
    """View a user's profile by ID with IDOR protection.
    
    This endpoint demonstrates proper authorization checks to prevent
    Indirect Object Reference (IDOR) vulnerabilities. Users can only
    view their own profile or admin users can view any profile.
    """
    # Fetch the profile
    try:
